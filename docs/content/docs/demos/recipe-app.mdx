...
The Recipe App uses direct `fetch()` calls to the Refyne API for synchronous extraction. This is the simplest way to integrate - no SDK required:
...
export async function extractRecipe(
  ...
  // Direct POST to the extract endpoint
  ...
  // Response contains extracted data directly
...
|--------------------------|---------------------------|
| Simple, single API call | Start job, poll for results |
