...
const settingsNavigation = [
  ...
  { name: 'LLM Keys', href: '/dashboard/llm-keys', icon: LLMKeyIcon },
  { name: 'LLM Models', href: '/dashboard/llm-models', icon: ModelsIcon },
...
function WebhookIcon({ className }: { className?: string }) {
  // Link icon - represents connections/callbacks
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
function LLMKeyIcon({ className }: { className?: string }) {
  // CPU chip icon - represents AI/LLM providers
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
